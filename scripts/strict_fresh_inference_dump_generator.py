...
def run_eval(run_dir: Path, model: str, dataset: str, seed: int, device_type: str, gpus: str) -> None:
...
def main() -> None:
    ...
    parser.add_argument("--device-type", default="gpu", choices=["cpu", "gpu"])
    ...
    for seed in args.seeds:
        ...
        run_eval(run_dir, args.model, args.dataset, seed, args.device_type, args.gpus)
