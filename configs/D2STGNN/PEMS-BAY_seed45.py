...
CFG = EasyDict()
CFG.SEED = 45  # Multi-seed experiment
# General settings
CFG.DESCRIPTION = 'D2STGNN PEMS-BAY Multi-Seed Experiment - Seed 45'
...
CFG.TRAIN.CKPT_SAVE_DIR = os.path.join(
    'checkpoints',
    MODEL_ARCH.__name__,
    '_'.join([DATA_NAME, str(CFG.TRAIN.NUM_EPOCHS), str(INPUT_LEN), str(OUTPUT_LEN), 'seed45'])
)
